  ...
  return (
    <>
      ...
      >
          ...
          <nav class="relative px-3 lg:px-12 container lg:flex justify-between items-center max-h-18 z-20">
            ...
            >
              <Link href="/" onClick={onClickLogo} noScroll class={`py-3 flex w-9 `}>
                ...
                <img class="w-full h-auto" src={logo} alt="Cofee bean logo" />
              </Link>
            </div>
            <ScrollShadow
        ...
        >
          <div class="absolute mt-2 ltr:mr-5 rtl:ml-12 border rounded-md w-40 transition-composite bg-white dark:bg-solid-gray shadow-md">
